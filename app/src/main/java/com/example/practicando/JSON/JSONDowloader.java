package com.example.practicando.JSON;

import android.app.ProgressDialog;
import android.os.AsyncTask;
import android.widget.Toast;

import com.example.practicando.MainActivity;
...
public class JSONDowloader extends AsyncTask<String, Integer, String> {

    private MainActivity mainActivity;
    private ProgressDialog progressDialog;

    public JSONDowloader(MainActivity mainActivity) {
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Estamos Buscando su libro ...");
        progressDialog.show();
    }
